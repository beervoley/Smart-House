...
public class srfi13 extends ModuleBody {
    ...
    public static Object stringConcatenateReverse$V(Object string$Mnlist, Object[] argsArray) {
        ...
        try {
            ...
            try {
                try {
                    Object apply3 = Scheme.applyToArgs.apply3(loc$final.get(), ElementType.MATCH_ANY_LOCALNAME, strings.isString(loc$final.get()) ? Boolean.TRUE : Boolean.FALSE);
                    Procedure procedure3 = Scheme.applyToArgs;
                    try {
        ...
        switch (moduleMethod.selector) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            obj = objArr[5];
                            try {
                                return Integer.valueOf($PcStringPrefixLengthCi(obj7, length, intValue, obj4, intValue2, ((Number) obj).intValue()));
                            } catch (ClassCastException e) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            obj = objArr[5];
                            try {
                                return Integer.valueOf($PcStringSuffixLengthCi(obj7, length, intValue, obj4, intValue2, ((Number) obj).intValue()));
                            } catch (ClassCastException e2222) {
            ...
            case 237:
                ...
                while (true) {
                    length2--;
                    if (length2 < 0) {
                        return stringCompare$V(obj7, obj2, obj3, obj4, obj5, objArr3);
                    }
            ...
            case 238:
                ...
                while (true) {
                    length2--;
                    if (length2 < 0) {
                        return stringCompareCi$V(obj7, obj2, obj3, obj4, obj5, objArr3);
                    }
                    objArr3[length2] = objArr[length2 + 5];
                }
            case LispEscapeFormat.ESCAPE_NORMAL /*241*/:
            ...
            case 299:
                ...
                try {
                    ...
                    try {
                        ...
                        throw new WrongType(e3, "string-copy!", 3, obj7);
                    }
                } catch (ClassCastException e2222222222) {
            ...
            case ErrorMessages.ERROR_TWITTER_BLANK_CONSUMER_KEY_OR_SECRET /*302*/:
                ...
                try {
                    ...
                    throw new WrongType(e32, "%string-copy!", 1, obj7);
                }
            case ErrorMessages.ERROR_TWITTER_EXCEPTION /*303*/:
                obj3 = objArr[0];
                obj4 = objArr[1];
